...
MODEL_PATH = os.path.join(BASE_DIR, 'djangoproject2')
...
SECRET_KEY = 'django-insecure-rmsza55a=9&$@4-8=k5ulg*=)f4zwtdwk)pd!g$#(y&x@1ps&x'
...
DATABASES = {
    'default': {
        ...
        'NAME': env('DATABASE_NAME', default='studentadmin'), 
